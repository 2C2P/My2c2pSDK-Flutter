/*
 * Created by Nonthawatt Phogwittayapanu on 18/8/21 12:32 PM
...
import 'my2c2psdk_type.dart';
import 'my2c2psdk_response.dart';

class My2c2pSDKRequest {
  My2c2pSDKRequest({required this.privateKey})
      : this.merchantId = "",
  ...
  factory My2c2pSDKRequest.fromJson(String str) => My2c2pSDKRequest.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory My2c2pSDKRequest.fromMap(Map<String, dynamic> json) {
    final model = My2c2pSDKRequest(privateKey: json["privateKey"] == null ? null : json["privateKey"]);
